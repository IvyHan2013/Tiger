...
public class Print {
	...
	tiger.Temp.TempMap tmap;

	public Print(java.io.PrintStream o, tiger.Temp.TempMap t) {
		out = o;
		tmap = t;
	}
	...
	public Print(java.io.PrintStream o) {
		out = o;
		tmap = new tiger.Temp.DefaultMap();
	}
